...
const EditScholarshipModal = ({ scholarship, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.put(`/api/scholarships/${scholarship.id}/`, formData);
      onSuccess();
    } catch (err) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-2xl w-full max-h-screen overflow-y-auto">
        ...
        <div className="bg-gray-200 px-6 py-4 flex justify-between items-center">
          <h2 className="text-xl font-semibold text-gray-800">Edit Scholarship</h2>
          <button
            onClick={onClose}
